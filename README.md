...
| [UltraPokechill 汉化版](https://github.com/ONonameO/UltraPokechill-zh-cn) | UltraPokechill 的汉化版本，新增 / 修改部分 Mod | 
...
| Mod | 名称 | 版本 | 功能简介 | 作者 | 类别 |
| --- | --- | --- | --- | --- | --- |
| betterDex | 更好的图鉴 | 1.1 | 属性筛选支持单属性匹配，新增招式筛选功能 | UltraPokechill | 图鉴 |
| betterMoveSorting | 更好的招式排序 | 1.5 | 已习得招式列表支持关键词筛选与排序，并为每个招式添加标签 | UltraPokechill | 宝可梦 UI |
| shinyEvolve | 闪光进化 | 1.6 | 闪光宝可梦进化后仍保持闪光形态 | UltraPokechill | 进化 |
| cosmoemEvolves | 科斯莫姆进化 | 1.4 | 商店新增科斯莫古糖果，使用后可使科斯莫古在昼夜分别进化为索尔迦雷欧 / 露奈雅拉 | UltraPokechill | 进化 |
| Pokerus Filter | 宝可病毒筛选 | 1.0 | 图鉴中新增筛选器，快速查找携带宝可病毒的宝可梦 | LPF | 图鉴 |
| editTeamFightAgain | 编辑队伍再战 | 1.4 | 战斗结算界面新增按钮，可先编辑队伍再重战 | UltraPokechill | 战斗 |
| noMoreMagikarp | 再见！鲤鱼王！ | 1.0 | 修复超级次元奖励错误发放鲤鱼王的问题 | UltraPokechill | Bug 修复 |
| bulkCandyUse | 糖果批量使用 | 1.1 | 使用神奇糖果时可一次性使用多颗 | UltraPokechill | 道具 |
| incomplete_families | 未集齐的闪光家族 | 1.1 | 闪光筛选中定位尚未集齐闪光形态的家族 | LPF | 图鉴 |
| betterGenetics | 更好的遗传 | 1.1 | 遗传界面快捷使用能量根，并提供 5 秒快速遗传模式 | UltraPokechill | 遗传 |
| backupMod | Discord 备份 | 1.2 | 每 10 分钟自动备份存档至 Discord | UltraPokechill | 实用工具 |
| shinyFamily | 闪光家族 | 1.3 | 家族中任一已解锁宝可梦为闪光时，全家族已解锁成员自动闪光 | UltraPokechill | 进化 |
| fatigueRemover | 疲劳伤害消除 | 1.0 | 移除战斗疲劳造成的 HP 损失 | UltraPokechill | 战斗 |
| multiHeartScale | 心之鳞片批量使用 | 1.0 | 使用心之鳞片时可一次性回忆多个招式 | UltraPokechill | 道具 |
...
- **游戏本体（Pokechill / UltraPokechill）**：由原作者以原项目许可发布，使用与二次分发请遵循其仓库中的许可证条款。
- **本汉化改版**：在遵循原许可的前提下进行汉化并新增 / 修改部分 Mod，若进行二次分发或改版，请保留原作者署名与项目地址。

---

## 致谢

- **原版 Pokechill** ：[play-pokechill/play-pokechill.github.io](https://github.com/play-pokechill/play-pokechill.github.io)
- **改版 UltraPokechill** ：[play-ultrapokechill/play-ultrapokechill.github.io](https://github.com/play-ultrapokechill/play-ultrapokechill.github.io)
- **中文翻译与中文搜索脚本作者**：GPT-DiamondMoo、CCC、黄黄、Reso
- **Mod 作者**：详见上方「内置 Mod」与「创意工坊」
