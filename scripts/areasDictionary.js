...
areas.expertDojoIII = {
    ...
    drops: {
        common: [item.nothing],
        uncommon: [item.movePsychicTm, item.powerGemTm, item.shadowBallTm, item.dragonPulseTm, item.darkPulseTm, item.playRoughTm]
    },
}
...
areas.eventScreamTail = {
    ...
    team: {
        ...
        slot1Moves: [move.moonblast.id, move.movePsychic.id, move.hyperVoice.id, move.disarmingVoice.id],
    },
...
areas.eventCosmoem = {
    ...
    team: {
        slot1: pkmn.cosmoem,
        slot1Moves: [move.calmMind.id, move.shadowBall.id, move.movePsychic.id, move.extrasensory.id],
    },
    reward: [pkmn.cosmog],
    category: 1,
}
...
areas.eventTapuLele = {
    ...
    team: {
        slot1: pkmn.tapuLele,
        slot1Moves: [move.mistBall.id, move.movePsychic.id, move.moonblast.id, move.fireBlast.id],
    },
...
areas.eventCresselia = {
    ...
    team: {
        ...
        slot1Moves: [move.calmMind.id, move.movePsychic.id, move.moonblast.id, move.airShlash.id],
    },
...
areas.eventMesprit = {
    ...
    team: {
        slot1: pkmn.mesprit,
        slot1Moves: [move.calmMind.id, move.movePsychic.id, move.extrasensory.id, move.moonblast.id],
    },
    reward: [pkmn.mesprit],
    category: 1,
}
...
areas.eventAzelf = {
    ...
    team: {
        slot1: pkmn.azelf,
        slot1Moves: [move.nastyPlot.id, move.movePsychic.id, move.extrasensory.id, move.moonblast.id],
    },
    reward: [pkmn.azelf],
    category: 1,
}
...
areas.eventUxie = {
    ...
    team: {
        slot1: pkmn.uxie,
        slot1Moves: [move.amnesia.id, move.movePsychic.id, move.extrasensory.id, move.moonblast.id],
    },
    reward: [pkmn.uxie],
    category: 1,
}
...
areas.eventMegaAlakazam = {
    ...
    team: {
        ...
        slot1Moves: [move.amnesia.id, move.movePsychic.id, move.energyBall.id, move.moonblast.id],
    },
...
areas.vsRocketGrunt1 = {
    ...
    team: {
        ...
        slot6: pkmn.haunter,
        slot6Moves: [move.hex.id, move.ominousWind.id, move.movePsychic.id],
    },
...
areas.vsGymLeaderMisty = {
    ...
    team: {
        ...
        slot6: pkmn.starmie,
        slot6Moves: [move.movePsychic.id, move.auroraBeam.id, move.waterPulse.id],
    },
...
areas.vsSwimmerDan = {
    ...
    team: {
        ...
        slot6Moves: [move.movePsychic.id, move.zenHeadbut.id, move.surf.id],
    },
...
areas.vsVeteranToshiro = {
    ...
    team: {
        ...
        slot5: pkmn.beheeyem,
        slot5Moves: [move.futureSight.id, move.movePsychic.id, move.zenHeadbut.id],
        slot6: pkmn.shiftry,
...
areas.vsGymLeaderPhoebe = {
    ...
    team: {
        ...
        slot2Moves: [move.ominousWind.id, move.movePsychic.id, move.shadowBall.id, move.thunderWave.id],
        slot3: pkmn.gengar,
...
areas.vsEliteTrainerCynthia = {
    ...
    team: {
        ...
        slot2: pkmn.porygonZ,
        slot2Moves: [move.triAttack.id, move.movePsychic.id, move.hyperBeam.id, move.nastyPlot.id],
        slot3: pkmn.milotic,
        slot3Moves: [move.scald.id, move.waterfall.id, move.liquidation.id, move.movePsychic.id],
...
areas.vsTeamLeaderMaxie = {
    ...
    team: {
        slot1: pkmn.delphox,
        slot1Moves: [move.confuseRay.id, move.movePsychic.id, move.extrasensory.id],
...
areas.vsTeamLeaderGiovanni = {
    ...
    team: {
        ...
        slot6: pkmn.mewtwo,
        slot6Moves: [move.calmMind.id, move.movePsychic.id, move.shadowBall.id, move.confuseRay.id],
    },
...
areas.vsMasterTrainerAlder = {
    ...
    team: {
        ...
        slot2Moves: [move.calmMind.id, move.fireBlast.id, move.movePsychic.id],
...
areas.vsLegendTrainerLillie = {
    ...
    team: {
        ...
        slot2: pkmn.tapuLele,
        slot2Moves: [move.calmMind.id, move.movePsychic.id, move.flamethrower.id],
...
areas.vsLegendTrainerSilver = {
    ...
    team: {
        ...
        slot3Moves: [move.amnesia.id, move.movePsychic.id, move.bugBuzz.id],
        slot4: pkmn.megaMeganium,
        slot4Moves: [move.stunSpore.id, move.leafStorm.id, move.spiritBreak.id],
        slot5: pkmn.lugia,
        slot5Moves: [move.calmMind.id, move.aeroblast.id, move.movePsychic.id],
        slot6: pkmn.hooh,
...
areas.vsLegendTrainerBrendan = {
    ...
    team: {
        ...
        slot6Moves: [move.calmMind.id, move.dragonPulse.id, move.movePsychic.id, move.flashCannon.id],
    },
...
areas.vsLegendTrainerAZ = {
    ...
    team: {
        ...
        slot5Moves: [move.sweetKiss.id, move.airShlash.id, move.movePsychic.id],
...
areas.vsPokemonProfessorOak = {
    ...
    team: {
        ...
        slot2Moves: [move.thunderbolt.id, move.movePsychic.id, move.moonblast.id, move.iceBeam.id],
